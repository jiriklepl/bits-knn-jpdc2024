...
def plot(file, hostname, jobid):
    ...
    fig.savefig(f"figures/kselection-sp-untuned-{hostname}-{jobid}.pgf", bbox_inches='tight')
    fig.savefig(f"figures/kselection-sp-untuned-{hostname}-{jobid}.pdf", bbox_inches='tight')
