...
template void warp_select_runner::operator()<64, 2, 256>();
template void warp_select_runner::operator()<64, 3, 256>();
template void warp_select_runner::operator()<64, 4, 256>();
template void warp_select_runner::operator()<64, 5, 256>();
template void warp_select_runner::operator()<64, 6, 256>();
template void warp_select_runner::operator()<64, 7, 256>();
template void warp_select_runner::operator()<64, 8, 256>();
template void warp_select_runner::operator()<64, 9, 256>();
template void warp_select_runner::operator()<64, 10, 256>();
