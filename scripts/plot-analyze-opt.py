...
categorization = {
    "bits": {
        ...
        "q != 64 && k <= 128": lambda df: (df["query_count"] != 64) & (df["k"] <= 128),
        "q != 64 && k == 256": lambda df: (df["query_count"] != 64) & (df["k"] == 256),
        "q != 64 && k == 512": lambda df: (df["query_count"] != 64) & (df["k"] == 512),
        "q != 64 && k == 1024": lambda df: (df["query_count"] != 64) & (df["k"] == 1024),
        "q != 64 && k == 2048": lambda df: (df["query_count"] != 64) & (df["k"] == 2048),
    },
    "bits-prefetch": {
        "q == 64": lambda df: df["query_count"] == 64,
        "q != 64 && k <= 256": lambda df: (df["query_count"] != 64) & (df["k"] <= 256),
    ...
    #     "q == 512": lambda df: df["query_count"] == 512,
    #     "q == 1024": lambda df: df["query_count"] == 1024,
    #     "q == 2048": lambda df: df["query_count"] == 2048,
    #     "q == 4096": lambda df: df["query_count"] == 4096,
    #     "q == 8192": lambda df: df["query_count"] == 8192,
    # },
    "fused-cache": {
        "q == 256": lambda df: df["query_count"] == 256,
        "q == 512": lambda df: df["query_count"] == 512,
        "q == 1024": lambda df: df["query_count"] == 1024,
        "q == 2048": lambda df: df["query_count"] == 2048,
        "q > 2048 && k <= 16": lambda df: (df["query_count"] > 2048) & (df["k"] <= 16),
        "q > 2048 && k == 32": lambda df: (df["query_count"] > 2048) & (df["k"] == 32),
        "q > 2048 && k == 64": lambda df: (df["query_count"] > 2048) & (df["k"] == 64),
        "q > 2048 && k > 64": lambda df: (df["query_count"] > 2048) & (df["k"] > 64),
    },
    "partial-bitonic": {
        "q == 64": lambda df: df["query_count"] == 64,
        "q != 64 && k <= 64": lambda df: (df["query_count"] != 64) & (df["k"] <= 64),
        "q != 64 && k > 64 && k <= 256": lambda df: (df["query_count"] != 64) & (df["k"] > 64) & (df["k"] <= 256),
        "q != 64 && k > 256 && k <= 2048": lambda df: (df["query_count"] != 64) & (df["k"] > 256) & (df["k"] <= 2048),
    },
    "partial-bitonic-regs": {
        "q == 64": lambda df: df["query_count"] == 64,
        "q == 256 && k <= 128": lambda df: (df["query_count"] == 256) & (df["k"] <= 128),
        "q == 256 && k > 128": lambda df: (df["query_count"] == 256) & (df["k"] > 128),
        "q > 256 && k <= 1024": lambda df: (df["query_count"] > 256) & (df["k"] <= 1024),
        "q > 256 && k == 2048": lambda df: (df["query_count"] > 256) & (df["k"] == 2048),
    },
    "partial-bitonic-warp": {
        "q == 64": lambda df: df["query_count"] == 64,
        "q == 256": lambda df: (df["query_count"] == 256),
        "q > 256 && k <= 32": lambda df: (df["query_count"] > 256) & (df["k"] <= 32),
        "q > 256 && k == 64": lambda df: (df["query_count"] > 256) & (df["k"] == 64),
        "q > 256 && k > 64": lambda df: (df["query_count"] > 256) & (df["k"] > 64),
    },
    "partial-bitonic-warp-static": {
        ...
        # "q == 256": lambda df: (df["query_count"] == 256),
        "q <= 256 && k <= 128": lambda df: (df["query_count"] <= 256) & (df["k"] <= 128),
        "q <= 256 && k == 256": lambda df: (df["query_count"] <= 256) & (df["k"] == 256),
        "q <= 256 && k > 256": lambda df: (df["query_count"] <= 256) & (df["k"] > 256),
        "q > 256 && k <= 32": lambda df: (df["query_count"] > 256) & (df["k"] <= 32),
        # "q > 256 && k > 32 && k <= 128": lambda df: (df["query_count"] > 256) & (df["k"] > 32) & (df["k"] <= 128),
        "q > 256 && k == 64": lambda df: (df["query_count"] > 256) & (df["k"] == 64),
        "q > 256 && k == 128": lambda df: (df["query_count"] > 256) & (df["k"] == 128),
        "q > 256 && k > 128": lambda df: (df["query_count"] > 256) & (df["k"] > 128),
    },
