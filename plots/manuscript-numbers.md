...
| Timing variation (std/mean): maximum | 8.93% | 11.32% | 7.55% | 27.85% | 3.52% |
...
| Fixed partial-bitonic: block; worst slowdown | 128; 45.52% | 128; 29.21% | 128; 33.80% | 128; 31.28% | — |
| Fixed partial-bitonic-warp: block; worst slowdown | 128; 96.21% | 128; 44.16% | 128; 53.92% | 128; 29.25% | — |
| Fixed partial-bitonic-warp-static: block; worst slowdown | 128; 83.58% | 128; 42.44% | 128; 57.99% | 128; 38.27% | — |
| Fixed partial-bitonic-regs: block; worst slowdown | 128; 49.45% | 128; 30.37% | 128; 17.60% | 128; 21.49% | — |
...
| Fixed bits parameters: block; items; degree | 512; 5,1,1; 1 | 512; 5,1,1; 1 | 512; 7,1,1; 1 | 256; 13,1,1; 1 | — |
| Fixed bits worst slowdown | 16.43% | 1.72% | 27.11% | 31.60% | — |
| MAGMA-distance wins vs other plotted kernels | 25/28 | 24/28 | 24/28 | 27/28 | 22/28 |
| Distance parameters fixed per d: worst slowdown | 1.94% | 5.29% | 3.53% | 1.29% | — |
...
| Fixed bits-fused parameters: query tile; items tuple; degree | 1; 8,4,1; 2 | 2; 4,4,4; 1 | 2; 4,4,1; 4 | 1; 8,4,2; 1 | — |
| Fixed bits-fused worst slowdown | 34.34% | 45.62% | 41.57% | 27.10% | — |
| Fixed bits-fused vs RAFT: worst overhead (tuning/eval) | -14.30% | -6.43% | 22.40% | 6.38% | — |
| Fixed bits-fused vs RAFT: worst workload | n=131072, q=8192, d=16, k=8 | n=131072, q=8192, d=16, k=8 | n=1048576, q=1024, d=16, k=8 | n=1048576, q=1024, d=16, k=8 | — |
| Fixed bits-fused wins vs two-phase (tuning/eval) | 72/72 | 72/72 | 60/72 | 60/72 | — |
...
| opt-bitonic-sort | 108290 | 108293 | 108291 | 101133 |  |
| opt-ipt | 108190, 108202, 108205 | 108187, 108199, 108203 | 108188, 108200, 108206 | 108189, 108201, 108204 |  |
| opt-distances | 108258 | 108256 | 108255 | 101154 |  |
| fused-cache-params | 108238, 108242, 108246 | 108241, 108245, 108248 | 108240, 108243, 108247 | 108239, 108244, 108249 |  |
