...
template void warp_select_runner::operator()<64, 2, 1024>();
template void warp_select_runner::operator()<64, 3, 1024>();
template void warp_select_runner::operator()<64, 4, 1024>();
template void warp_select_runner::operator()<64, 5, 1024>();
template void warp_select_runner::operator()<64, 6, 1024>();
template void warp_select_runner::operator()<64, 7, 1024>();
template void warp_select_runner::operator()<64, 8, 1024>();
template void warp_select_runner::operator()<64, 9, 1024>();
template void warp_select_runner::operator()<64, 10, 1024>();
